function DPCluster_TimeCourseEqual(fileName, uniqueIdentifier, nSamples, dataType, drawFigures, hyperParameterSamplingFrequency, verbose, initialise, gammaPrior, thinningFreq, varargin)
...
if(drawFigures)
    ...
    if(size(varargin,2) == 0)
        figure
        nClustersOld = doPlots_TimeCourse(clusterIDs, data,featureNames, 0, nClustersOld);
    else
        nClustersOld = doPlots_TimeCourse(clusterIDs, data,featureNames, 0, nClustersOld, varargin{1});
    end
    pause(0.1)
end
